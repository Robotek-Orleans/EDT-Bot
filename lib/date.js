...
/**
 * @param {Date} date
 * @param {string} flag t, T, d, D, f (default), F, R https://gist.github.com/LeviSnoot/d9147767abeef2f770e9ddcd91eb85aa
 */
export function getDiscordTimestamp(date, flag) {
	if (flag)
		return `<t:${Math.floor(date.getTime() / 1000)}:${flag}>`;
}
